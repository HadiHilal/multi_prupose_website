...
@section('title' , __('admin.EditTestimonial'))
...
@section('toolbar')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <!--begin::Title-->
        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__('admin.EditTestimonial')}}</h1>
        <!--end::Title-->
        <!--begin::Separator-->
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">{{__('admin.EditTestimonial')}}</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('content')
    <div class="card">
        ...
        <div class="card-header">
            <!--begin::Card title-->
            <div class="card-title fs-3 fw-bolder">{{__('admin.EditTestimonial')}}</div>
            <!--end::Card title-->
        </div>
        <!--end::Card header-->
        <!--begin::Form-->
        <form id="kt_project_settings_form" class="form" method="post" action="{{ route('admin.testimonials.update') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="name" value="{{old('name' ,$model->name )}}" placeholder="Jone Doe" />
                               <div class="fv-plugins-message-container invalid-feedback">
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="position"  value="{{old('position' ,$model->position)}}" placeholder="Manger" />
                             <div class="fv-plugins-message-container invalid-feedback">
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row">
                        <textarea name="comment" class="form-control form-control-solid h-100px">{{old('comment' ,$model->comment)}}</textarea>
                            <div class="fv-plugins-message-container invalid-feedback">
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid" name="link" value="{{old('link' ,$model->link)}}"  placeholder="www.facebook.com/jone-doe" />
                              <div class="fv-plugins-message-container invalid-feedback">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row">
                        <div class="form-check form-switch form-check-custom form-check-solid me-10">
                            <input class="form-check-input h-30px w-50px" {{$model->publish == 1 ? 'checked' : ''}}  type="checkbox" name="publish" id="flexSwitch30x50"/>
                        </div>
                    </div>
                </div>
                <!--end::Row-->
