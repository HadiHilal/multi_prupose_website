...
@section('title' , __('admin.AddNewBlog'))
...
@section('toolbar')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <!--begin::Title-->
        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__('admin.AddNewBlog')}}</h1>
        <!--end::Title-->
        <!--begin::Separator-->
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">{{__('admin.AddNewBlog')}}</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('content')
        ...
        <div class="card-header">
            <!--begin::Card title-->
            <div class="card-title fs-3 fw-bolder">{{__('admin.AddNewBlog')}}</div>
            <!--end::Card title-->
        </div>
        <form method="POST" action="{{route('admin.blogs.store')}}" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="row mb-8">
                    <!--begin::Col-->
                    <div class="col-xl-3">
                        <div class="fs-6 fw-bold mt-2 mb-3">{{__('admin.BlogLink')}} <span class="text-danger">*</span></div>
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid"  id="gslug"  placeholder="example: how to be developer" />
                          <input type="hidden" name="slug" value="" id="slug">
                            <div class="fv-plugins-message-container invalid-feedback">
                                 <x-input-error class="mt-2" :messages="$errors->get('slug')" />
                        </div>
                        <div class="my-3" id="link"></div>
                ...
                <div class="row mb-8">
                     ...
                     <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="intro" value="{{old('intro')}}"  />
                                    <div class="fv-plugins-message-container invalid-feedback">
                         ...
                         <div class="row mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-9 fv-row">
                                      <textarea name="content" class="form-control form-control-solid " id="tinymce">{!! old('content') !!}</textarea>
                                    <div class="fv-plugins-message-container invalid-feedback">
...
@section('js')
   <script src="{{ asset('admin/plugins/global/plugins.bundle.js') }}"></script>
    ...
    <script>
        ...
        if (slug !== ''){
             $('#link').addClass('text-primary').text("{{env('APP_URL')}}/blogs/" +slug);
             $('#slug').val(slug);
        }else {
            $('#link').addClass('text-danger').text("{{__('admin.TheSlugShouldBeEnglish')}}");
        }
