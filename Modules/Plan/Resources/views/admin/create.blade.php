...
@section('toolbar')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <!--begin::Title-->
        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{__('admin.AddNewPlan')}}</h1>
        <!--end::Title-->
        <!--begin::Separator-->
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">{{__('admin.AddNewPlan')}}</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('content')
        ...
        <div class="card-header">
            <!--begin::Card title-->
            <div class="card-title fs-3 fw-bolder">{{__('admin.AddNewPlan')}}</div>
            <!--end::Card title-->
        </div>
                ...
                <div class="row mb-8">
                     ...
                     <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row ">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="price" value="{{old('price')}}"  />
                                    </div>
                         ...
                         <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row">
                                           <select class="form-select" data-control="select2" name="duration" data-placeholder="Select an option">
                                                <option></option>
                                                <option {{old('duration') == 'Monthly' ? 'selected' : '' }} value="Monthly">Monthly</option>
                                                <option {{old('duration') == 'Yearly' ? 'selected' : '' }} value="Yearly">Yearly</option>
                                            </select>
                      ...
                      <div id="repeaterContainer">
                            <div class="row mb-8 feature-container">
                                ...
                                <div class="col-xl-6 fv-row">
                                    <input type="text" class="form-control form-control-solid feature" name="feature[]">
                                </div>
                                <div class="col-xl-2">
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" checked name="included[]" type="checkbox"/>
                                   ...
                                   <div class="col-xl-1">
                                             <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-feature-btn">
...
@section('js')
    ...
    <script>
       $(document).ready(function() {
            var featureContainer = $('#repeaterContainer .feature-container').first().clone();
